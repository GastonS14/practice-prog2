...
La mencionada anteriormente es la única forma de consultar y retirar elementos de la colección, es decir, no se pueden obtener ni consultar elementos de otra posición que no sea el tope de la pila.
